...
var proyectosData = [
  ...
  },
  {
    ...
    "imagenes": [
      "K-PMLD-PROYECTO-Z-09.png",
      "K-PMLD - IMG-IA-004.png",
      "K-PMLD-PROYECTO-Z-01.png",
      "K-PMLD-PROYECTO-Z-10.png",
  ...
  },
  {
    "id": "p1785621111673",
    "codigo": "H-WSSH",
    "nombre": "WELLNESS  SPA  -  SERE Hotel",
    "tipologia": "H",
    "estado": "Activo",
    "anio_inicio": "2026",
    "anio_fin": "",
    ...
    "concepto_es": "",
    "concepto_en": "",
    "web_es": "WELLNESS  SPA  -  SERE Hotel\nUn destino de bienestar diseñado para transformar la estadía en una experiencia memorable.\nEl   Wellness  Spa  de  SERE  Hotel   fue concebido como la pieza central de la estrategia de remodelación y reposicionamiento del hotel, entendiendo a la arquitectura como una herramienta para generar valor a través de la experiencia.   Más que un conjunto de instalaciones de bienestar, el proyecto propone un recorrido cuidadosamente diseñado que fortalece el vínculo emocional del huésped con el lugar, convirtiendo el relax y el bienestar en uno de los recuerdos más significativos de su estadía.\nLa secuencia espacial guía al usuario a través de un circuito integral de bienestar que combina experiencias de agua, calor y relajación.   El recorrido incluye una piscina climatizada con jets de hidromasaje, burbujas y cascadas, complementada por sauna seco, sauna húmedo, ducha escocesa, ducha de sensaciones, salas de masajes individuales y para parejas, culminando en una sala de relax concebida como el cierre del recorrido y el momento de mayor contemplación.\n\nEn todo el proyecto, la arquitectura, la iluminación, la materialidad y la percepción sensorial trabajan de manera integrada para crear una atmósfera de calma, confort y desconexión. Cada espacio fue diseñado para acompañar una transición gradual desde el ritmo cotidiano hacia un estado de bienestar físico y mental, reforzando la identidad del hotel a través de una experiencia inmersiva y cuidadosamente planificada.\n\nComo parte de la remodelación integral y puesta en valor del emblemático  SERE Hotel  (ex - Hotel El Faro) de Villa Carlos Paz, el spa aprovecha uno de los mayores atributos del edificio: sus excepcionales vistas panorámicas hacia las Sierras de Córdoba. La arquitectura enmarca el paisaje y convierte la cambiante luz natural —especialmente durante el atardecer— en un componente esencial de la experiencia, estableciendo un diálogo permanente entre bienestar, naturaleza y arquitectura.",
    "web_en": "WELLNESS  SPA  –  SERE  Hotel\n\nA wellness destination designed to transform the stay into a memorable experience.\n\nThe  Wellness Spa  at  SERE Hotel  was conceived as the centerpiece of the hotel's renovation and repositioning strategy, understanding architecture as a tool for creating value through experience. More than a set of wellness facilities, the project proposes a carefully designed journey that strengthens the guest's emotional connection to the place, turning relaxation and wellbeing into one of the most meaningful memories of their stay.\n\nThe spatial sequence guides guests through a comprehensive wellness circuit combining water, heat, and relaxation experiences.  The journey includes a heated pool with hydromassage jets, bubbles, and waterfalls, complemented by a dry sauna, wet sauna, Scottish shower, sensation shower, individual and couples' massage rooms, culminating in a relaxation room conceived as the closing moment of the journey and the point of deepest contemplation.\n\nThroughout the project, architecture, lighting, materiality, and sensory perception work together to create an atmosphere of calm, comfort, and disconnection.  Each space was designed to accompany a gradual transition from everyday rhythm to a state of physical and mental wellbeing, reinforcing the hotel's identity through an immersive, carefully planned experience.\n\nAs part of the comprehensive renovation and revitalization of the iconic  SERE Hotel  (formerly Hotel El Faro) in Villa Carlos Paz, the spa capitalizes on one of the building's greatest assets: its exceptional panoramic views of the Sierras de Córdoba. The architecture frames the landscape, turning the ever-changing natural light — especially at sunset — into an essential component of the experience, establishing an ongoing dialogue between wellness, nature, and architecture.",
    "imagenes": [
      "H-SEFCP-SPA-01.png",
      "H-SEFCP-SPA-02a.png",
      "H-SEFCP-SPA-02b.png",
